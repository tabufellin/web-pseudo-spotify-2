...
const Stadistics = () => {
  ...
  {/*///////////////////////////////////////////////////////////////////*/ }
    ...
    <button id="1" className="hola"> hola</button>
    ...
    <button id="2" className="hola"> hola</button>
    ...
    <button id="3" className="hola"> hola</button>
    ...
    <button id="4" className="hola"> hola</button>
    ...
    <button id="5" className="hola"> hola</button>
    ...
    <button id="6" className="hola"> hola</button>
    ...
    <button id="7" className="hola"> hola</button>
